...
const T = {
  en:{
    ...
    "about.title":"About",
    "cam.ask":"For the full experience, allow camera access — your reflection will appear in the lenses. Then scroll.","cam.on":"Camera on",
  ...
  fa:{
    ...
    "about.title":"درباره",
    "cam.ask":"برای تجربهٔ کامل، دسترسی دوربین را اجازه بدهید — تصویر شما در عدسی‌ها می‌افتد. بعد اسکرول کنید.","cam.on":"دوربین روشن است",
