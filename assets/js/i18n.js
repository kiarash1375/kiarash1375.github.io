...
const T = {
  en:{
    ...
    "about.title":"About",
    "cam.ask":"Allow camera access — the lenses will show what they see","cam.on":"Camera on",
  ...
  fa:{
    ...
    "about.title":"درباره",
    "cam.ask":"دسترسی دوربین را اجازه بدهید — عدسی‌ها همان را نشان می‌دهند","cam.on":"دوربین روشن است",
